  ...
  const pathways = [
    {
      ...
      stops: [
        ...
        { num: 4, title: 'The Authority in His Name', status: 'coming-soon' },
        { num: 5, title: 'Echad — One', status: 'coming-soon' },
        { num: 6, title: 'Begotten', status: 'coming-soon' },
        { num: 7, title: 'The Roles', status: 'coming-soon' },
        { num: 8, title: 'Ruach — The Spirit', status: 'coming-soon' },
        { num: 9, title: 'Lord — The Cover-Up', status: 'coming-soon' },
        { num: 10, title: 'The Original Faith', status: 'coming-soon' },
      ],
      status: 'active',
